          ...
          <div className="filter-section">
            ...
            <div className="price-range-box">
              <div className="price-inputs">
                <div className="price-input">₹ {price[0]}</div>

                <div className="price-input">₹ {price[1]}</div>
              </div>
                  ...
                  {allHomes.map((home) => (
                    ...
                    >
                      ...
                      <div className="price-section">
                        ...
                        <h2>
                          ₹{Number(home.price).toLocaleString("en-IN")}
                        </h2>
...
{allHomes.length === 0 ? (
  ...
  <>
                <div className="pagination">
                  ...
                  <button  id='pagination-btn'disabled={allHomes.length <= 5 ? true : false} 
                  ...
                  <button id='pagination-btn' disabled={allHomes.length <= 5 ? true : false}  onClick={() => setPage(2)}>{">"}</button>
                </div>
